...
public class AdicionarFragment extends Fragment {
    ...
    private void adicionar () {
        if /*(spMae.getSelectedItem() == null) {
            Toast.makeText(getActivity(), "Por favor, selecione o aluno!", Toast.LENGTH_LONG).show();
        } else if*/ (spMedico.getSelectedItem() == null) {
            Toast.makeText(getActivity(), "Por favor, selecione o professor!", Toast.LENGTH_LONG).show();
           ...
           /* b.setData_nascimento(etDataNascimento.getText().toString());
            ...
            Toast.makeText(getActivity(), "Polo salvo!", Toast.LENGTH_LONG).show();
